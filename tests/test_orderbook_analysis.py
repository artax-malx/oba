...
def test_resample_data():
    ...
    dft = analysis.get_test_order_book_data()

    df_samp  = analysis.resample_data(dft, 2)

    output = np.array([[1.7500e+02, 1.0065e+04, 4.6000e+01, 1.0075e+04, 4.2000e+01],
    ...
    index = np.array([200, 300, 400, 500, 600])
